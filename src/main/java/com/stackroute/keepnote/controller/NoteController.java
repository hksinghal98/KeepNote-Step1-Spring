 ...
 * */
@Controller
public class NoteController<ModalMap> {
	/*
	 * From the problem statement, we can understand that the application
	 * requires us to implement the following functionaries.
	 * 
	...
	private ApplicationContext noteContext;

    public NoteController() {
        noteContext = new ClassPathXmlApplicationContext("beans.xml");
        this.note = (Note) noteContext.getBean("note");
        this.noteRepository = (NoteRepository) noteContext.getBean("noteRepository");
    }
	...
	*/
    ...
    public String addNote(@RequestParam int noteId, String noteTitle, String noteContent, String noteStatus, ModelMap model){
		this.note = (Note) noteContext.getBean("note");
